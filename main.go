...
func printUsage() {
	...
	fmt.Println()
	fmt.Println("Example:")
	fmt.Println("  nssh -R 8080:localhost:80 user@example.com -p 2122 -P password            # foreground (testing)")
	fmt.Println("  nssh -R 8080:localhost:80 user@example.com -p 2122 -P password --daemon   # background daemon (auto-reconnect)")
	fmt.Println()
	fmt.Println("Options:")
	...
	fmt.Println("  pip:          pip install nssh")
	fmt.Println("  binary:       https://github.com/Vrolist/nssh/releases")
	fmt.Println("  binary(CN):   https://www.neiwangyun.net/client/download/")
	...
	fmt.Println("  binary:       re-download from https://github.com/Vrolist/nssh/releases")
	fmt.Println("  binary(CN):   re-download from https://www.neiwangyun.net/client/download/")
